...
public class CustomListener extends TestListenerAdapter {
    ...
    public void onTestFailure(ITestResult tr) {
        ...
        LogEntries logEntries = Driver.getWebDriver().manage().logs().get(LogType.BROWSER);
        ...
        for (LogEntry entry : logEntries.getAll()) {
            ...
            extentTest.log(LogStatus.INFO, "Browser Log Info", new Date(entry.getTimestamp()) + " " + entry.getLevel() + " " + entry.getMessage());
        }
    }
